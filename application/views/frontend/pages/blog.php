                ...
                <div class="pr--100">
                    <div class="isotope_item vrbloglist">
                        <div class="item-image">
                            <a href="#"><img src="<?= base_url('assets/'); ?>images/blog/blog-post-1.jpg" alt="blog" class="img-fluid"> </a>
            ...
            <div class="col-lg-4 m-mt30">
                <div class="sidebar">
                    ...
                    <div class="offer-image">
                        <img src="<?= base_url('assets/'); ?>images/blog/strategy-guide.jpg" alt="offer" class="img-fluid" />
                    </div>
                    ...
                    <div class="recent-post widgets mt60">
                        ...
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="#"><img src="<?= base_url('assets/'); ?>images/blog/blog-small.jpg" alt="girl" class="img-fluid" /></a>
                            </div>
                        ...
                        <div class="media">
                            <div class="post-image bdr-radius">
                                <a href="#"><img src="<?= base_url('assets/'); ?>images/blog/blog-small2.jpg" alt="girl" class="img-fluid" /></a>
                            </div>
                            <div class="media-body post-info">
                                <h5><a href="#">Stock Market App Development - Time, Cost, Features</a></h5>
                                <p>September 24, 2019</p>
                    ...
                    <div class="offer-image mt60">
                        <img src="<?= base_url('assets/'); ?>images/blog/sidebar-image.jpg" alt="offer" class="img-fluid" />
                    </div>
                    <!--End block for offer/ads-->
                </div>
            </div>
