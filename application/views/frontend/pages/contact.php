        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5 contact2dv">
                ...
                <div class="info-wrapr">
                    ...
                    <div class="dbox d-flex align-items-start">
                        <div class="text pl-4">
                            <p>Untuk informasi lebih lanjut, anda dapat menghubungi kami melalui alamat dibawah ini. Anda juga dapat memanfaatkan form isian yang ada dibagian kanan halaman ini.</p>
                        </div>
                    </div>
                    <!--Start Location-->
                    ...
                    <div class="dbox d-flex align-items-start">
                        ...
                        <div class="text pl-4">
                            <p><span>Mobile Number :</span> <a href="tel://1234567920">+6281314050080</a></p>
                        </div>
                    </div>
            ...
            <div class="col-lg-7 m-mt30 pr30 pl30">
                <div class="common-heading text-l">
                    <h2 class="mt0 mb0">Contact Us</h2>
                    <p class="mb60 mt10">Silahkan pergunakan form dibawah ini untuk menghubungi kami, kami akan menghubungi kembali anda sesegera mungkin.</p>
                </div>
                <div class="form-block">
                    <form id="contactForm" data-bs-toggle="validator" class="shake">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <input type="text" id="mobile" placeholder="Title" required data-error="Please fill Out">
                                <div class="help-block with-errors"></div>
                            </div>
                            <!-- <div class="form-group col-sm-6">
                                <select name="Dtype" id="Dtype" required>
        ...
        <div class="row justify-content-left">
            <div class="col-lg-7">
                <div class="niwax23form shadow">
                    <div class="common-heading text-l">
                        <h2 class="mt0 mb0">Contact Us</h2>
                        <p class="mb50 mt10">Silahkan pergunakan form dibawah ini untuk menghubungi kami, kami akan menghubungi kembali anda sesegera mungkin.</p>
                    </div>
